...
export default function Home() {
  return (
    <Layout title="Book Assessments">
      <MainNav />
      <main className="content-container">
        <section className="section-header">
          <div className="sticky-header">
            <h1 className="section-title">Book Assessments</h1>
            <p className="section-subtitle">Test your knowledge of topics covered in one of our reviewed books</p>
          </div>
